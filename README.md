...
Chạy app Node.js cùng SQL Server:
...
Khi chạy lần đầu, container SQL Server sẽ tự tạo database `THITRACNGHIEM` và import dữ liệu từ `THITRACNGHIEM.sql`. Nếu muốn import lại từ đầu sau khi sửa file SQL, xóa volume database rồi chạy lại:
